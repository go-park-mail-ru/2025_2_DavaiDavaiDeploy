...
type CompilationsUsecase interface {
	...
	GetFilmsByCompilation(ctx context.Context, id uuid.UUID, userID uuid.UUID, pager models.Pager) ([]models.CompFilm, error)
}
...
type CompilationsRepo interface {
	...
	GetFilmsByCompilation(ctx context.Context, compilationID uuid.UUID, limit, offset int) ([]models.CompFilm, error)
}
